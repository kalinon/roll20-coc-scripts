...
type AttributeCreationProperties =
    CharacterChildObjectCreationProperties
    & Partial<AttributeMutableSynchronousGetProperties>;
type AbilityCreationProperties =
    CharacterChildObjectCreationProperties
    & Partial<AbilityMutableSynchronousGetProperties>;
...
declare function randomInteger(int: number): number;
